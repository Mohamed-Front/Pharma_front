...
"send_notification": "Send Notification",
    ...
    "cancel": "Cancel",
    "send": "Send",
    "missing_fields": "Please fill all required fields (Type, Recipients, English Title, English Body).",
    "sent": "Notification sent successfully.",
    "sendError": "Failed to send notification.",
    "loadError": "Failed to load notifications.",
    "loadPharmaciesError": "Failed to load pharmacies.",
    "loadWarehousesError": "Failed to load warehouses.",
    ...
    "no_title": "No Title",
    "no_body": "No Body",
    "noData": "No notifications in this section."
  },
  user: {
    users: "Users",
    new: "New",
...
"address": {
  ...
  "success.reviewAdded": "Your review has been submitted successfully.",
  "warning": "Warning",
  ...
  "cart": {
    ...
    "giftCantRemove": "Gift products cannot be removed directly.",
    "giftCantModify": "Gift quantities are based on active offers and cannot be modified.",
    "gift": "Gift",
    "unknownGift": "Unknown Gift",
    "minLimit": "Min",
    "maxLimit": "Max",
    "eligibleGifts": "You will receive {count} gift(s)!",
    "needMore": "Add {needed} more to qualify for gift",
  ...
  "contact": {
    ...
    "area": "Area Name, City Name",
    "workingHours": "We are available from Sunday to Thursday",
    "emailTitle": "Email Us",
    "emailResponse": "Get a reply within 24 hours",
    "phoneTitle": "Call Us",
    "phoneHours": "From 9 AM to 5 PM",
    "formTitle": "Have a question or comment? Fill the form below.",
  ...
  "settings": {
    ...
    "fileTypes": "PNG, JPG, JPEG up to 2MB",
    "changeLogo": "Click to change logo",
    "invalidImageType": "Please upload a valid image file (PNG, JPG, JPEG)",
  ...
  "validation": {
    ...
    "phoneRequired": "Phone number is required",
    "phoneTooLong": "Phone number must be 15 characters or less",
    "locationRequired": "Location is required",
    "invalidLat": "Latitude must be a valid number between -90 and 90",
    "invalidLong": "Longitude must be a valid number between -180 and 180"
  },
  "success": "Success",
  "error": {
    "error": "Error",
    "mapClick": "Unable to retrieve coordinates from map click",
  ...
  report: {
    ...
    pharmaciesTitle: 'Pharmacies Report',
    searchProducts: 'Search Products',
    export: 'Export to CSV',
    "warehousesTitle": "Warehouses Report",
    "pharmaciesTitle": "Pharmacies Report",
    "searchWarehouses": "Search Warehouses",
    "searchPharmacies": "Search Pharmacies",
    "export": "Export",
    "noDataToExport": "No data available to export",
    "warehousesLoadError": "Failed to load warehouses report",
    "noWarehousesData": "No warehouses data available",
    noDataToExport: 'No data available to export',
    productsLoadError: 'Failed to load products report',
    pharmaciesLoadError: 'Failed to load pharmacies report',
    noProductsData: 'No products data available',
    noPharmaciesData: 'No pharmacies data available',
 ...
 "offer": {
    ...
    "off": "Off",
    "fixed_off": "Fixed Off",
    "buy_x_get_y": "Buy {buy} Get {free} Free",
    "unknown": "Unknown",
    "select_product": "Select product",
    "select_gift_product": "Select gift product",
    "select_quantity_unit": "Select unit",
    "select_discount_type": "Select discount type",
    "enter_quantity": "Enter quantity",
    "enter_discount_value": "Enter discount value",
    "enter_gift_quantity": "Enter gift quantity",
    "enter_min_limit": "Enter min limit",
    "enter_max_limit": "Enter max limit",
    "enter_start_date": "Select start date",
    "enter_end_date": "Select end date",
  ...
  "dashboard": {
    ...
    "welcome_message": "Welcome to the Pharmabank Admin Dashboard",
    "companies": "Companies",
    "total_companies": "Total Companies Registered",
    "pharmacies": "Pharmacies",
    "total_pharmacies": "Total Pharmacies Registered",
    "warehouses": "Warehouses",
    "total_warehouses": "Total Warehouses Registered",
    "categories": "Categories",
   ...
   "control": {
    ...
    "welcome_message": "Welcome back! Here is a summary of your key metrics and recent activity.",
    "companies": "Companies",
    "total_companies": "Total Registered Companies",
    "categories": "Categories",
    "total_categories": "Total Product Categories",
    "orders": "Orders",
    ...
    "best_performing_pharmacies": "Best Performing Pharmacies",
    "recent_orders": "Recent Orders",
    "refresh": "Refresh",
    "view_all": "View All",
    "error_fetching_data": "Could not fetch control panel data. Displaying fallback data.",
    "no_data_products": "No best-selling products data available.",
    "no_data_pharmacies": "No top pharmacies data available.",
    "table": {
      "order_id": "Order ID",
      "customer": "Customer",
      "date": "Date",
...
"expiration_from": "Expiration From",
  ...
  "profile": {
    ...
    phone: 'Phone Number',
    phone_required: 'Phone number is required',
    phone_too_long: 'Phone number must not exceed 15 characters',
    ...
    location: 'Location',
    pharmacy_logo: 'Warehouse Logo',
    click_to_upload: 'Click to upload',
    or_drag_and_drop: 'or drag and drop',
    click_or_drag_to_change_photo: 'Click or drag to change photo',
    invalid_image_type: 'Invalid file type. Please upload an image (SVG, PNG, JPG, or GIF).',
    image_too_large: 'Image size exceeds 1MB limit.',
    orders: 'Orders',
